        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <div class="banner-content text-center">
                    ...
                    <p class="banner-subtitle animate__animated animate__fadeInUp">Send a message across the realms of Pagalan</p>
                ...
                <div class="contact-info">
                    ...
                    <div class="social-connect">
                        ...
                        <div class="social-links">
                            <a href="https://www.facebook.com/thepagalanchronicles" target="_blank" aria-label="Facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
                            <a href="https://www.instagram.com/thepagalanchronicles" target="_blank" aria-label="Instagram"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                            <a href="https://www.tiktok.com/@thepagalanchronicles" target="_blank" aria-label="TikTok"><i class="fab fa-tiktok" aria-hidden="true"></i></a>
                            <a href="https://www.youtube.com/thepagalanchronicles" target="_blank" aria-label="YouTube"><i class="fab fa-youtube" aria-hidden="true"></i></a>
                            <a href="https://www.tumblr.com/thepagalanchronicles" target="_blank" aria-label="Tumblr"><i class="fab fa-tumblr" aria-hidden="true"></i></a>
                            <a href="https://twitter.com/pagalanbooks" target="_blank" aria-label="Twitter"><i class="fab fa-x-twitter" aria-hidden="true"></i></a>
                            <a href="https://www.linkedin.com/company/thepagalanchronicles" target="_blank" aria-label="LinkedIn"><i class="fab fa-linkedin-in" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" required value="{{ old('name') }}" aria-describedby="nameHelp">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" required value="{{ old('email') }}" aria-describedby="emailHelp">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content bg-dark text-white">
            ...
            <div class="modal-body text-center">
                ...
                <a href="{{ asset('images/map/PagalanMap.jpg') }}" class="btn btn-primary mt-3" download>Download Full Map</a>
            </div>
        </div>
    </div>
</div>
