...
.page-banner::before {
    ...
    width: 100%;
    height: 100%;
    background: url("{{ asset('images/characters/bannerCharacters.jpg') }}") repeat;
    opacity: 0.2;
...
@keyframes filmGrain {
    ...
    30% { background-position: 5% -45%; }
    40% { background-position: -5% -25%; }
    50% { background-position: -45% 45%; }
    60% { background-position: 45% 5%; }
    70% { background-position: 5% 25%; }
    80% { background-position: -25% 15%; }
    90% { background-position: 30% -15%; }
}
...
@keyframes btnGlow {
    ...
    .book-info .btn {
        ...
        background: linear-gradient(135deg, #0d0914 0%, #100d1a 100%);
        color: white;
        border: none;
...
.audiobook-section::before {
    ...
    right: 0;
    bottom: 0;
    background: url("{{ asset('images/bg/sound-waves.png') }}") repeat;
    opacity: 0.1;
...
/* Responsive Styles */
@media (max-width: 991.98px) {
    .trailer-wrapper, .audiobook-wrapper {
        flex-direction: column;
    }
    
    .trailer-info, .audiobook-info {
        order: 2;
    }
    
    .trailer-container, .audiobook-showcase {
        order: 1;
        width: 100%;
    }
...
@media (max-width: 767.98px) {
    ...
    .trailer-info h3, .audiobook-info h3 {
        font-size: 1.5rem;
    }
    
    .trailer-features, .audiobook-features {
        flex-direction: column;
        gap: 1.5rem;
    }
    
    .trailer-features .feature, .audiobook-features .feature {
        padding: 0.5rem;
    }
...
@media (max-width: 575.98px) {
    ...
    .trailer-info p, .audiobook-info p {
        font-size: 1rem;
    }
...
<style>
    ...
    .book-platforms::before {
        ...
        right: 0;
        bottom: 0;
        background: url("{{ asset('images/bg/constellation.png') }}") repeat;
        opacity: 0.15;
    ...
    @keyframes platformGlow {
        ...
        100% { transform: rotate(45deg) scale(1); opacity: 0.4; }
    }
                    ...
                    <div class="col-lg-4 col-md-6 mb-5">
                        <div class="book-card">
                            <div class="book-cover">
                                <img src="{{ asset($book->cover_image) }}" alt="Book {{ $book->book_number }} - {{ Str::of($book->slug)->replace('-', ' ')->title() }}">
                            </div>
                            <div class="book-info">
                                <h3>Book {{ $book->book_number }}: {{ Str::of($book->slug)->replace('-', ' ')->title() }}</h3>
                                <p class="release-date">Coming {{ $book->release_date }}</p>
                                <a href="{{ route('books.show', $book->slug) }}" class="btn">Discover More</a>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="trailer-wrapper">
            <div class="trailer-container">
                ...
                <div class="video-player" id="video-player">
                    <iframe id="trailer-iframe" src="https://www.youtube.com/embed/Ay2Ii4QUOGg?si=r_QrluQ1icDskF6-" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div class="trailer-info">
                <h3>The Pagalan Chronicles: Official Trailer</h3>
                <p>Step into a world where magic flows through ancient forests, forgotten kingdoms await rediscovery, and prophesied heroes emerge from the shadows. This exclusive trailer offers a glimpse into the epic adventure that awaits in The Pagalan Chronicles.</p>
    ...
    <div class="container">
        ...
        <div class="audiobook-wrapper">
            <div class="audiobook-showcase">
                <img src="{{ asset('images/characters/banner3.jpg') }}" alt="Pagalan Chronicles Audiobook" class="audiobook-cover">
                ...
                <div class="audio-player">
                    ...
                    <div class="audio-controls">
                        ...
                        <div class="control-buttons">
                            ...
                            <button id="play-audio-btn" class="control-btn play-btn"><i class="fas fa-play"></i></button>
            ...
            <div class="audiobook-info">
                ...
                <p>Immerse yourself in the world of Pagalan with our professionally narrated audiobooks. Perfect for experiencing the epic adventure during your commute, workout, or anytime you want to be transported to another world.</p>
                ...
                <div class="audiobook-platforms">
                    ...
                    <div class="platform-logos">
                        <a href="#" class="platform-logo"><img src="{{ asset('images/platforms/audible.png') }}" alt="Audible"></a>
                        <a href="#" class="platform-logo"><img src="{{ asset('images/platforms/apple-books.png') }}" alt="Apple Books"></a>
                        <a href="#" class="platform-logo"><img src="{{ asset('images/platforms/google-play.png') }}" alt="Google Play"></a>
                    </div>
                </div>
...
<section class="subscribe-section" id="subscribe">
    <div class="container">
        ...
        <p>Subscribe to receive updates about release dates, special offers, and exclusive content from the magical world of Pagalan.</p>
...
<section class="author-quote">
    <div class="container">
        <div class="quote-container">
            ...
            <blockquote>
                <p>"If we can stand together through adversity, no matter how severe that is, then there is always hope that the glimmer becomes a beacon of light that outshines even the bleakest moments."</p>
