        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                    {{-- <svg class="book-icon me-2" width="40" height="40" viewBox="0 0 24 24" fill="none"
                    ...
                    <img src="{{ asset('images/characters/logo3.png') }}" alt="The Pagalan Chronicles"
                        class="logo mb-3">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarMain">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::is('world') ? 'active' : '' }}"
                                href="{{ route('world') }}">World of Pagalan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Route::is('author') ? 'active' : '' }}"
                                href="{{ route('author') }}">The Author</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="social-links d-flex gap-3">
                        <a href="https://www.facebook.com/andy.stonehold?locale=en_GB" target="_blank"
                            aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/thepagalanchronicles" target="_blank"
                            aria-label="Instagram"><i class="fab fa-instagram"></i></a>
                        <a href="https://www.tiktok.com/@stonehold55555?_t=8rORYh79Fo1" target="_blank"
                            aria-label="TikTok"><i class="fab fa-tiktok"></i></a>
                        <a href="https://www.youtube.com/@andrewhoulston9925" target="_blank" aria-label="YouTube"><i
                                class="fab fa-youtube"></i></a>
                        <a href="https://www.tumblr.com/blog/stonehold55555" target="_blank" aria-label="Tumblr"><i
                                class="fab fa-tumblr"></i></a>
                        <a href="https://www.instagram.com/andrewhoulston232/profilecard/?igsh=MnIzc2F3ZzNkanpz"
                            target="_blank" aria-label="Twitter"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.linkedin.com/in/andrew-houlston-5b296972?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
